...
Fast travel is disabled, but there are now more carriage routes available thanks to [Carriage and Ferry Travel Overhaul](https://www.nexusmods.com/skyrimspecialedition/mods/8379). Consider buying a horse when able, but take care not to get them killed. A horse will also be useful to carry more things : Thanks to [Gift by Hand VR](https://www.nexusmods.com/skyrimspecialedition/mods/99809) you can access your horse's inventory by triple-grasping them (grasping them three times in quick succession). You can also call your horse at any time with the [Call your Horse](https://www.nexusmods.com/skyrimspecialedition/mods/49595) power.
