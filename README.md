...
The third option, Molag Bal's Subjugation, is easier than both Incubus Arts and Knockout Arts to use but is entirely unavailable as a starting character and requires investing into Illusion.
...
- [Sexlab Enchantress](https://www.loverslab.com/files/file/9712-sexlab-enchantress-se) provides sexlab-related versions of the basic illusion spells. These spells do not replace the actual basic illusion spells, there will usually be a regular version and an erotic version of the spell that can be learned separately.  
